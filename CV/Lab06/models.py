...
class Models:
    ...
    def lstm(self):
        model = Sequential()
        model.add(LSTM(128, input_shape=self.input_shape))  # https://keras.io/api/layers/recurrent_layers/lstm/
    ...
    def cnnlstm(self):
        model = Sequential()  # https://keras.io/api/layers/recurrent_layers/time_distributed/
    ...
    def convlstm(self):
        model = Sequential()  # https://keras.io/api/layers/recurrent_layers/conv_lstm2d/
